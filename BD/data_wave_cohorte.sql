...
CREATE TABLE `cohorte` (
  ...
  `desde` int NOT NULL,
  `hasta` int NOT NULL,
  `tipoaperturaId` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tipoaperturaId` (`tipoaperturaId`),
  CONSTRAINT `cohorte_ibfk_1` FOREIGN KEY (`tipoaperturaId`) REFERENCES `tipoapertura` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `cohorte` VALUES (1,2024,2026,1),(2,2024,2026,2),(3,2023,2025,1),(4,2023,2025,2);
